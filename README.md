...
For the details on the derivation of the BSM formula and its link to the replication strategy as well as other interesting information, check the contents of from Columbia's Foundations of Financial Engineering course: (https://martin-haugh.github.io/teaching/foundations-fe/)
# Option replication :
